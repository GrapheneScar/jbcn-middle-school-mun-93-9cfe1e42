...
const TeamPhoto = () => <motion.div className="w-full max-w-3xl mx-auto mb-16 overflow-hidden glass-panel p-4" initial={{
  opacity: 0,
  y: 20
}} animate={{
  opacity: 1,
...
const DepartmentSection = ({
  ...
  return <motion.section className="mb-20" initial={{
    ...
    delay: 0.1 * index
      ...
      {department.description && <p className="text-white/70 text-center max-w-2xl mx-auto mb-8">
...
const ChairCard = ({
  ...
  return <Card className="overflow-hidden bg-black/20 border-mun-purple/20 hover:border-mun-purple/60 transition-all duration-300 hover:shadow-[0_0_15px_rgba(121,83,169,0.2)] transform hover:-translate-y-1">
      <div className="relative aspect-square overflow-hidden">
        <img src={chair.photo} alt={chair.name} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
      </div>
...
const CommitteeHeads = () => {
  ...
  return <PageTransition>
      ...
      <section className="pt-32 pb-12 px-4 relative">
        <div className="container mx-auto">
          ...
          visible: {
            ...
            <motion.h1 className="text-5xl md:text-6xl font-bold text-white mb-6" variants={{
            hidden: {
              opacity: 0,
              y: 20
            },
            ...
            <motion.div className="w-20 h-1 bg-mun-purple mx-auto mb-8" variants={{
            hidden: {
              width: 0
            },
            visible: {
            ...
            <motion.p className="text-lg text-white/80 max-w-3xl mx-auto mb-12" variants={{
            hidden: {
              opacity: 0,
              y: 20
            },
      ...
      <div className="container mx-auto px-4 pb-20">
        ...
        {committeeHeads.map((department, index) => <div key={department.name}>
            <DepartmentSection department={department} index={index} />
            {index < committeeHeads.length - 1 && <Separator className="max-w-xs mx-auto bg-mun-purple/30 mb-20" />}
          </div>)}
      </div>
    </PageTransition>;
};
