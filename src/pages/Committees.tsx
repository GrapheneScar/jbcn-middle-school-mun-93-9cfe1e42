            ...
            <div className="relative z-10 space-y-4 text-white/90 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-6">
                <div className="bg-black/30 p-4 rounded-lg border border-mun-purple/20">
                  <h4 className="text-lg font-bold text-mun-purple-light mb-2">Historical Perspectives</h4>
                  <p className="text-sm">
                ...
                <div className="bg-black/30 p-4 rounded-lg border border-mun-purple/20">
                  <h4 className="text-lg font-bold text-mun-purple-light mb-2">Crisis Management</h4>
                  <p className="text-sm">
                ...
                <div className="bg-black/30 p-4 rounded-lg border border-mun-purple/20">
                  <h4 className="text-lg font-bold text-mun-purple-light mb-2">Future Exploration</h4>
                  <p className="text-sm">
                ...
                <div className="bg-black/30 p-4 rounded-lg border border-mun-purple/20">
                  <h4 className="text-lg font-bold text-mun-purple-light mb-2">Global Security</h4>
                  <p className="text-sm">
