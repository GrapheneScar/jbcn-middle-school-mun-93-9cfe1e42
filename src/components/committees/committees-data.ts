...
export const committeesData: Committee[] = [
  {
    ...
    background: "Welcome to DISEC, where we all attempt to bring peace through our resolutions while the plethora of mercenaries break it. This year's agenda? Private Military Organizations (PMOs), the freelancers of war who just can't seem to get enough money. Are they really the security experts as we know them or international chaos machines exploiting conflict zones? Some argue they 'assist' in conflicts (get paid to persecute people living through war), while others say they're just capitalism's version of war, why employ soldiers when you can hire some on a paid subscription plan? Groups like Wagner, Blackwater, and Aegis Defense have turned global conflict into their bread and butter, often operating outside the law and making governments and sovereignty look like side characters. So, delegates, the burning question is: are PMOs necessary evils, or just evils with a booming business model? Get ready to debate, expose deals, and maybe find a common solution. So are you delegates ready? Because we are!",
