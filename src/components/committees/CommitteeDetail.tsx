      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center mb-6">
            <div className="w-20 h-20 rounded-full bg-mun-purple/20 flex items-center justify-center overflow-hidden mr-6 mb-4 md:mb-0">
              {committee.logo ? (
                <img src={committee.logo} alt={`${committee.abbr} logo`} className="w-full h-full object-cover" />
              ) : (
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid grid-cols-3 mb-8 py-0 mx-0 my-0 px-[12px] rounded-3xl">
            ...
            <TabsTrigger value="chairs" className="px-[64px]">Committee Chairs</TabsTrigger>
          </TabsList>
                ...
                <Table>
                  ...
                  <TableBody>
                    {committee.chairs.map((chair, index) => (
                      ...
                      >
                        <TableCell className="font-semibold text-white">{chair.title}</TableCell>
                        <TableCell className="text-white/90">{chair.name}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
