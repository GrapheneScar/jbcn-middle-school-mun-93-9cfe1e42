...
export const RegisterButton = ({ className = "" }: RegisterButtonProps) => {
  ...
  return (
    <div className={`${className} flex flex-col items-center justify-center z-20 relative`}>
      <a 
        ...
        <div className="relative group">
          <Button 
            className={`relative overflow-hidden text-white font-medium px-6 py-5 
              ...
              hover:shadow-[0_0_15px_rgba(121,83,169,0.4)]`}
            size="lg"
            style={{
              zIndex: 10
            }}
      ...
      <p className="text-sm text-white/70 italic mt-2">Registration closes on 10th April 2025</p>
    </div>
  );
};
