        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          type: "tween"
            ...
            <div className="glass-panel p-8 rounded-xl border border-mun-purple/30 text-white/90">
              ...
              <p className="mb-8">Our conference aims to foster critical thinking, public speaking, leadership, and problem-solving skills in middle school students, preparing them to be informed global citizens.</p>
          ...
          type: "tween"
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-white mb-6">What is Model United Nations (MUN)?</h2>
            </div>
            ...
            <div className="glass-panel p-8 rounded-xl border border-mun-purple/30 text-white/90">
              ...
              <p>Through research, drafting, public speaking, and negotiation, students develop a deeper understanding of global challenges and the complexities of solving them through international cooperation.</p>
            </div>
          </motion.div>
        </div>
      </div>
