      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-white/80 max-w-2xl mx-auto mt-4">
            We aim to foster an environment where students develop critical thinking, diplomacy, and leadership skills through engaging Model United Nations experiences.
          </p>
        </motion.div>
