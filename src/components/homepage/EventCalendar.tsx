...
const EventCalendar = () => {
  ...
  return <motion.div initial={{
    ...
    duration: 0.5
  }} className="glass-panel p-4 relative overflow-hidden px-[16px] py-[16px] my-0 mx-[75px]">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <div className="w-full sm:w-auto flex-shrink-0 bg-black/40 rounded-xl p-2 border border-mun-purple/20">
          <Calendar mode="single" selected={date} onSelect={setDate} className="p-0 pointer-events-auto scale-90 origin-top" modifiers={{
