...
const HeroSection = () => {
  ...
  // Set conference date (April 25, 2024 - from EventCalendar)
  ...
  return <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <motion.div className="container mx-auto relative z-10" variants={containerVariants} initial="hidden" animate="visible">
        <div className="text-center">
          <motion.h1 variants={itemVariants} className="text-5xl lg:text-8xl font-bold text-white tracking-tighter leading-none mb-6 md:text-6xl mx-0 my-[38px]">
