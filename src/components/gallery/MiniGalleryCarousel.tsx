      ...
      loop: true
        ...
        <CarouselContent>
          {displayImages.map(image => <CarouselItem key={image.id} className="md:basis-1/2 lg:basis-1/3">
              <div className="overflow-hidden rounded-lg shadow-md transition-all duration-200 hover:shadow-lg cursor-pointer" onClick={() => onImageClick && onImageClick(image.id)}>
